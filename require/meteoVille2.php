    ...
    <div class="card-body tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="j+1" role="tabpanel" aria-labelledby="j+1-tab">
            ...
            <p>
                ...
                Temp. Max : <?php echo $meteo2['list'][8]['main']['temp_max']-273,15 ." C°"; ?><br/>
                Temp. Min : <?php echo $meteo2['list'][8]['main']['temp_min']-273,15 ." C°"; ?><br/>
        ...
        <div class="tab-pane fade" id="j+2" role="tabpanel" aria-labelledby="j+2-tab">
            ...
            <p>
                ...
                Temp. Max : <?php echo $meteo2['list'][16]['main']['temp_max']-273,15 ." C°"; ?><br/>
                Temp. Min : <?php echo $meteo2['list'][16]['main']['temp_min']-273,15 ." C°"; ?><br/>
        ...
        <div class="tab-pane fade" id="j+3" role="tabpanel" aria-labelledby="j+3-tab">
            ...
            <p>
                ...
                Temp. Max : <?php echo $meteo2['list'][24]['main']['temp_max']-273,15 ." C°"; ?><br/>
                Temp. Min : <?php echo $meteo2['list'][24]['main']['temp_min']-273,15 ." C°"; ?><br/>
        ...
        <div class="tab-pane fade" id="j+4" role="tabpanel" aria-labelledby="j+4-tab">
            ...
            <p>
                ...
                Temp. Max : <?php echo $meteo2['list'][32]['main']['temp_max']-273,15 ." C°"; ?><br/>
                Temp. Min : <?php echo $meteo2['list'][32]['main']['temp_min']-273,15 ." C°"; ?><br/>
        ...
        <div class="tab-pane fade" id="j+5" role="tabpanel" aria-labelledby="j+5-tab">
            <h4><?php echo $meteo2['list'][39]['dt_txt']; ?></h4>
            <h5>
                <img src="https://openweathermap.org/img/w/<?php echo $meteo2['list'][39]['weather'][0]['icon'] ?>.png" alt="temps">
                <?php echo $meteo2['list'][39]['weather'][0]['description']; ?>
            </h5>
            <p>
                Température : <?php echo $meteo2['list'][39]['main']['temp']-273,15 ." C°"; ?><br/>
                Temp. Max : <?php echo $meteo2['list'][39]['main']['temp_max']-273,15 ." C°"; ?><br/>
                Temp. Min : <?php echo $meteo2['list'][39]['main']['temp_min']-273,15 ." C°"; ?><br/>
                Humidité : <?php echo $meteo2['list'][39]['main']['humidity'].' %'; ?><br/>
                Pression : <?php echo $meteo2['list'][39]['main']['pressure'].' hpa'; ?><br/>
                Nuages : <?php echo $meteo2['list'][39]['clouds']['all'].' %'; ?><br/>
                Vent : <?php echo $meteo2['list'][39]['wind']['speed'].' m/s'; ?>
            </p>
        </div>
    </div>
</div>